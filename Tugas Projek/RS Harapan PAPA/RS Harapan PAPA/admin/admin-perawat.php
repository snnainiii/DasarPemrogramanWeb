                ...
                <div class="modal-body p-5">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="nip" data-inputmask="'mask': '999999'" id="nip" type="text" placeholder="Masukkan NIP" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Mobile Number</label>
                            <input class="form-control" data-inputmask="'mask': '+6299999999999'" name="mobile_number" type="text" placeholder="Masukkan mobile number" required>
                        </div>
                        <div class="col-md-6">
                ...
                <form action="../connection/function.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body p-5">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Mobile Number</label>
                                <input class="form-control" data-inputmask="'mask': '+6299999999999'" name="mobile_number" type="text" placeholder="Masukkan mobile number" value="<?= $row['mobile_number']; ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Spesialis</label>
                                <select class="form-select js-choice border-0 z-index-9 bg-transparent" aria-label=".form-select-sm" data-search-enabled="true" name="id_spesialis" required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-5">
                    ...
                    <div class="position-relative">
                        <img src="../assets/images/upload/perawat/<?= $row['profile_picture']; ?>" class="rounded-circle mx-auto d-block mb-3" alt="">
                    </div>
