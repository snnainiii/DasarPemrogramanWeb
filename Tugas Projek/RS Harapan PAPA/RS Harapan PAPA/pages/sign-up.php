				...
				<div class="col-12 col-lg-6 d-md-flex align-items-center justify-content-center bg-primary bg-opacity-10 vh-lg-100">
					<div class="p-3 p-lg-5">
						...
						<div class="d-sm-flex mt-4 align-items-center justify-content-center">
							...
							<!-- Content -->
							<p class="mb-0 h6 fw-light ms-0 ms-sm-3">18k+ Pasien bergabung dengan kami, sekarang
								giliran kamu.</p>
						</div>
					</div>
				</div>
						...
						<div class="col-sm-10 col-xl-8 m-auto">
							...
							<form>
								...
								<div class="align-items-center mt-0">
									<div class="d-grid">
										<button class="btn btn-primary mb-0" type="button">Daftar</button>
									</div>
								</div>
							</form>
							<!-- Form END -->
							...
							<div class="mt-4 text-center">
								<span>Sudah punya akun?<a href="sign-in.html"> Login</a></span>
							</div>
						</div>
					</div>
				</div>
